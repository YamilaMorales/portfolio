        ...
        <div class="row">
            <div class="col-12 col-sm-4 p-3">
                <div class="proyecto">
                    ...
                    <h2 class="p-3 d-block"> AMB clientes</h2>
                    <p class="p-3 d-block">Alta, baja y modificación de un registro de clientes. Realizado en HTML, CSS,
            ...
            <div class="col-12 col-sm-4 p-3">
                <div class="proyecto">
                    ...
                    <p class="p-3 d-block">Sistema de gestión de clientes, productos y ventas. Realizado en HTML, CSS,
